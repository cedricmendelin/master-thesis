    ...
    def _validate(self, validation_images, validation_snrs, batch_size):
        ...
        for snr in validation_snrs:
            ...
            for validation_data in loader:
                ...
                noisy_sinogrems = torch.cat([d.x for d in validation_data]).to(denoised_sinograms.device) # noisy sino
                ...
                fbps_noisy = self.model_fbp(noisy_sinogrems.view(batch_n, self.N, self.RESOLUTION))
