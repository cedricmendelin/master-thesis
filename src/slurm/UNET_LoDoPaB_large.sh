...
#SBATCH --job-name=unet_large #Name of your job
...
#SBATCH --gres=gpu:3
#SBATCH --output=log/unet_large.%j   #Path and name to the file for the STDOUT
#SBATCH --error=log/unet_large_error.%j    #Path and name to the file for the STDERR
