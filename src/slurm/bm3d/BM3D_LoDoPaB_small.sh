...
#SBATCH --job-name=bm3d_small #Name of your job
...
#SBATCH --gres=gpu:3
#SBATCH --output=log/bm3d_small.%j   #Path and name to the file for the STDOUT
#SBATCH --error=log/bm3d__small_error.%j    #Path and name to the file for the STDERR
...
python ./src/Bm3DValidationLoDoPaB_small.py --bm3d "RECO" --snr 0