...
dist_knn, idx_best_img_knn, angle_est_knn, reflect_est_knn = rotation_invariant_knn(original_images, K=K)
dist_knn_noisy, idx_best_img_knn_noisy, angle_est_knn_noisy, reflect_est_knn_noisy = rotation_invariant_knn(noisy_images, K=K)


#Laplacian
#A = create_adj_mat(classes)
A = create_adj_mat_nx(idx_best_img_knn)
...
A_noisy = create_adj_mat_nx(idx_best_img_knn_noisy)
