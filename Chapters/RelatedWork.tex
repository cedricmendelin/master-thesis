...
a way of link predication.


\section{Graph Deep Learning}

There are many new deep Learning techniques

Graph deep learning is a fast evolving field in research. With Graph Neural Networks (GNN)\cite{GNN}
