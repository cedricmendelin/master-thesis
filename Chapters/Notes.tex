...
\begin{itemize}
    \item vanilla graph classification
...
\begin{itemize}
    ...
    \item Other graph creation mechanism
...
A homophilic dataset leads to the tendency to interact with similiar nodes. Whereas a heterophilic dataset contratly has the tendendy to 
...
First of all, the node correlation is calculated with two multilayer peceptrons (MLP)
