...
\begin{frame}{Graph - Definitions}
  ...
  \begin{columns}
    ...
    \only<3>{
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{graph_undirected_2.drawio.png}
...
\begin{frame}{Computed Tomography with unknown angles}
  \pause
  \begin{itemize}
    \item GL - Embedding estimates observation angles for noiseless case.
    \item Can be applied during reconstruction.
  \end{itemize}
  ...
  \begin{figure}
    ...
    \only<6>{\alert{What happens in the noisy case?}}
