...
\begin{frame}[c]{Cryo-Electron Microscopy (Cryo-EM) - Challenges}
    \begin{columns}[c]
        \column{.45\textwidth}
...
\begin{frame}{Shared Observation Model}
    ...
    \begin{itemize}
        ...
        \item<4-> \alert<4>{$x$: biological sample}
    \end{itemize}
        ...
        \only<2->{
            \begin{figure}
                ...
                \begin{subfigure}[t]{0.45\textwidth}
                    ...
                    \caption{Reconstruction noisy with $SNR_y$ 0 dB: \\
                        $Recon(y, \theta) \not\approx x$}
                \end{subfigure}
            \end{figure}
        }
