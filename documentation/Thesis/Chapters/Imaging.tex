...
\begin{figure}[H]
    ...
    \hfill
    \subbottom[Clean Sinogram: $R(x, \theta, s) = y$   \label{fig:phantom_sinogram}]{\includegraphics[width=0.22\textwidth]{phantom_sino.png}}
    \hfill
...
\begin{figure}[H]
    ...
    % \centering
    \hfill
    \subbottom[Clean reconstruction: $FBP(y, \theta, s)$  \label{fig:fbp_phantom}]{\includegraphics[width=0.22\textwidth]{fbp_phantom_clean.png}}
    \hfill
    \subbottom[Noisy reconstruction: $FBP(y + \eta, \theta, s)$ \label{fig:fbp_phantom_noisy}]{\includegraphics[width=0.22\textwidth]{fbp_phantom_snr_10.png}}
    \hfill
...
\begin{figure}[H]
    ...
    \hfill
    \subbottom[Projection along X-Axis   \label{fig:omicron-x}]{\includegraphics[width=0.18\textwidth]{emd_32500.map_xprojection.jpeg}}
    \hfill
    \subbottom[Projection along Y-Axis   \label{fig:omicron-y}]{\includegraphics[width=0.18\textwidth]{emd_32500.map_yprojection.jpeg}}
    \hfill
    \subbottom[Projection along Z-Axis   \label{fig:omicron-z}]{\includegraphics[width=0.18\textwidth]{emd_32500.map_zprojection.jpeg}}
    \hfill
