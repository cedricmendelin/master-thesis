...
\begin{figure}[H]
    ...
    \centering
    \subbottom[Shepp-Logan phantom          \label{fig:phantom}]{\includegraphics[width=0.25\textwidth]{phantom.png}}
    \subbottom[Clean Sinogram            \label{fig:phantom_sinogram}]{\includegraphics[width=0.25\textwidth]{phantom_sinogram.png}}
    \subbottom[Noisy sinogram               \label{fig:phantom_sinogram_noisy}]{\includegraphics[width=0.25\textwidth]{phantom_sinogram_noisy_high.png}}
    \caption{Shepp-Logan phantom and sinogram}
\end{figure}

\textbf{TODO: Add some first images}
