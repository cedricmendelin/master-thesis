...
\begin{table}[H]
    ...
    \begin{tabular}{l|c|c|c|c}
      ...
      \textbf{Algorithm / Model} & \snrh{ 0} & \snrh{ -5} & \snrh{ -10} & \snrh{ -15} \\
                         & \small \small \textbf{SNR} & \small \small \textbf{SNR} & \small \small \textbf{SNR}  & \small \small \textbf{SNR} \\ 
      \midrule
...
\begin{table}[H]
  ...
  \begin{tabular}{l|cc}
    ...
    \textbf{k} & \multicolumn{2}{l|}{\snrh{ 0}}   \\
                       & \small \textbf{Loss} & \small \small \textbf{SNR}  \\ 
    \midrule
...
\begin{table}[H]
  ...
  \begin{tabular}{l|cc}
    \toprule
    \textbf{GAT dropout.} & \multicolumn{2}{l|}{\snrh{ -5}}   \\
                       & \small \textbf{Loss} & \small \small \textbf{SNR}  \\ 
    \midrule
...
\begin{table}[H]
  ...
  \begin{tabular}{l|cc|cc|cc|cc}
    ...
    \textbf{Algorithm} & \multicolumn{2}{l|}{\snrh{ 0}} & \multicolumn{2}{l|}{\snrh{ -5}} & \multicolumn{2}{l|}{\snrh{ -10}} & \multicolumn{2}{l}{\snrh{ -15}} \\
                       & \small \textbf{Loss} & \small \small \textbf{SNR} & \small \textbf{Loss} & \small \small \textbf{SNR} & \small \textbf{Loss} & \small \small \textbf{SNR} & \small \textbf{Loss} & \small \small \textbf{SNR} \\ 
    \midrule
